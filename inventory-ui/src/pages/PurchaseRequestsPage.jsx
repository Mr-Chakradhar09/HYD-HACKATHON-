  ...
  return (
    <Box>
      <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
        ...
        <Button variant="contained" sx={{marginLeft:5}} startIcon={<AddIcon />} onClick={() => { formik.resetForm(); if (user?.warehouseId) formik.setFieldValue('warehouseId', user.warehouseId.toString()); setDialogOpen(true); }}>
          New Request
        </Button>
      </Stack>
